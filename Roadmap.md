...
| Task 1.1 Bootstrap application | Create the base Laravel application structure and dependency management for TaskFlow. | todo |
| Task 1.2 Prepare local environment | Add Docker Compose services for app, web server, and relational database for local development. | todo |
